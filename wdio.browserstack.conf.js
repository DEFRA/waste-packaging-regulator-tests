...
export const config = {
  ...
  baseUrl: `https://waste-packaging-regulator-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `waste-packaging-regulator-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `waste-packaging-regulator-tests-${process.env.ENVIRONMENT}`
        },
